...
APP_NAME = 'bauer'.upper()
SQL_DSN = {
    "host"      : os.environ.get("%s_HOSTNAME" % APP_NAME, "bauer"),
    "db"        : os.environ.get("%s_DATABASE" % APP_NAME, "bauer"),
    "user"      : os.environ.get("%s_USERNAME" % APP_NAME, "bauer"),
    "passwd"    : os.environ.get("%s_PASSWORD" % APP_NAME, "bauer"),
    "use_unicode" : True,
}
