...
SECRET_KEY = os.environ.get('BAUER_DJANGO_KEY')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('BAUER_DEBUG', 'FALSE')

ALLOWED_HOSTS = ['*']

DB_USERNAME = os.environ.get('BAUER_USERNAME', 'bauer')
...
# App name and token
IFX_APP = {
    'token' : os.environ.get('BAUER_IFX_APP_TOKEN'),
    'name': 'bauer',
}
